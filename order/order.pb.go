...
const file_order_order_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xd5\x02\n" +
	"\fOrderService\x12>\n" +
...
var file_order_order_proto_depIdxs = []int32{
	...
	10, // 5: order.BalanceResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	6,  // 11: order.OrderService.CreateOrder:output_type -> order.OrderResponse
	6,  // 12: order.OrderService.GetOrder:output_type -> order.OrderResponse
	8,  // 13: order.OrderService.GetUserOrders:output_type -> order.ListOrdersResponse
	6,  // 14: order.OrderService.CancelOrder:output_type -> order.OrderResponse
	9,  // 15: order.OrderService.GetUserBalance:output_type -> order.BalanceResponse
